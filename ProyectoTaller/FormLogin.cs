        ...
        private void Loggearse(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(conexion))
                {
                    ...
                    string query = "SELECT u.ID_Usuario, u.Nombre, u.Apellido, u.Email, p.Descripcion FROM Usuarios u INNER JOIN Perfiles p ON u.ID_Perfiles = p.ID_Perfiles WHERE u.Email = @Email AND u.Pass = @Pass AND Baja = 1;";
